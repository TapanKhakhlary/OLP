      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            {[
              { key: 'progress', label: 'Reading Progress', description: "Get updates on your child's reading progress" },
              { key: 'grades', label: 'Grades & Feedback', description: "Receive notifications when assignments are graded" },
              { key: 'announcements', label: 'Class Announcements', description: "Stay informed about class announcements and events" },
              { key: 'weekly', label: 'Weekly Reports', description: "Get weekly summaries of your child's activity" }
            ].map((item) => (
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 border border-gray-200 rounded-lg">
              <h3 className="font-medium text-gray-900 mb-2">Child Data Privacy</h3>
              <p className="text-sm text-gray-600 mb-3">
                Your child's educational data is protected and only shared with authorized teachers.
              </p>
            ...
            <div className="p-4 border border-gray-200 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Keep your account secure to protect your child's information.
              </p>
              <button className="text-purple-600 hover:text-purple-800 text-sm font-medium">
                Change Password
              </button>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            <div className="p-4 border border-gray-200 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Contact our support team for assistance with monitoring your child's progress.
              </p>
              <button className="text-purple-600 hover:text-purple-800 text-sm font-medium">
                Contact Support
              </button>
